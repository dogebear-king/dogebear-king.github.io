...
GITHUB_REPONAME = "dogebear-king/dogebear-king.github.io"
...
task :publish => [:generate] do
  Dir.mktmpdir do |tmp|
    ...
    system "git add ."
    system "git config user.email 'dogebear.king@gmail.com'"
    system "git config user.name 'dogebear.king'"
    message = "Site updated at #{Time.now.utc}"
    system "git commit -am #{message.inspect}"
    system "git remote add origin https://github.com/dogebear-king/dogebear-king.github.io.git"
